...
vulnerabilities in their logitrack project. Your goal
...
and architecture belong to logitrack-quality-reviewer.
...
- **CSRF**: logitrack doesn't have CSRF protection
...
- **Stay in your lane**: don't comment on code
  ...
  — that's logitrack-quality-reviewer's job.
