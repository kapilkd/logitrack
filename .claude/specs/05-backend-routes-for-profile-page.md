...
- Response contains the seed user's email ("demo@logitrack.com")
...
- [ ] Logging in as the seed user (demo@logitrack.com / demo123) shows "Demo User" and "demo@logitrack.com" on the profile page — not the hardcoded strings
...
- [ ] Category breakdown shows DB categories with percentages that add up to 100 %
