...
This step establishes the **data layer foundation** for the logitrack application.
...
- Opens connection to `logitrack.db` (or `expense_tracker.db`) in project root
- Sets:
...
- Inserts one demo user:
  - name: Demo User
  - email: [demo@logitrack.com](mailto:demo@logitrack.com)
