...
description: Runs parallel security and quality code
  review for a specific logitrack feature. Pass the spec
...
**logitrack-security-reviewer** receives:
...
**logitrack-quality-reviewer** receives:
...
Security Findings
[logitrack-security-reviewer output]
Quality Findings
[logitrack-quality-reviewer output]
